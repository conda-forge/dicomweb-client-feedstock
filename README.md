...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dicomweb-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dicomweb-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dicomweb-client
# for installing globally
pixi global install dicomweb-client
```
...
It is possible to list all of the versions of `dicomweb-client` available on your platform:
...
```
pixi search dicomweb-client --channel conda-forge
```
